    ...
    <header id="header-wrap">
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          ...
          <a href="index2.php" class="navbar-brand"><img src="assets/img/logo.png" alt=""></a>       
          ...
          <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
              <div class="contents">
                ...
                <h2 class="head-title">Shout your Friends</h2>
                <h5 style="color: lightgreen;"><b>Free talk to the world you say all friends what is inside the box?</b></h5>
          ...
          <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="team-item wow fadeInRight" data-wow-delay="0.2s">
              ...
              <div class="contetn">
                ...
                <p>He basically all the front-end are design and 100% sure he make it.</p> 
          ...
          <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="team-item wow fadeInRight" data-wow-delay="0.4s">
              ...
              <div class="contetn">
                ...
                <p>He is c-sharp coder and he is fix the bugs of back-end.</p>
                <ul class="social-icons">
                  <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="lni-twitter-filled" aria-hidden="true"></i></a></li>
                  <li><a href="#"><i class="lni-instagram-filled" aria-hidden="true"></i></a></li>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="submit-button text-left">
                      ...
                      <p>Luigithemasterofall@gmail.com</p>
